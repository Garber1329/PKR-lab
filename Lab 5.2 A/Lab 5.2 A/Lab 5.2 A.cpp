...
void Create(const char* fName)
{
	...
	do {
		...
		cout << "Оцінка з інформатики: "; cin >> s.inform;
...
void Print(const char* fName)
{
	...
	cout << "============================================================================="
		<< endl;
	cout << "| №  |  Прізвище   | Курс |   Спеціальність   | Фізика | Матем. | Інформат. |"
		<< endl;
	cout << "============================================================================="
		<< endl;
...
string highestAverageScore(const char* fName) {
	...
	while (f.read((char*)&s, sizeof(Student))) {
		...
		stud = s.physics + s.maths + s.inform;
		if (stud > max) {
			max = stud;
			prizv = s.prizv;
		}
